...
[![gh-actions](https://img.shields.io/github/workflow/status/sigma-py/npx/tests.yml?branch=main&style=flat-square)](https://github.com/nschloe/npx/actions?query=workflow%3Aci)
